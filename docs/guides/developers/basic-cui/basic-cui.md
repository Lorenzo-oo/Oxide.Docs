...
```csharp
	new CuiScrollViewComponent
	{
		ContentTransform = new CuiRectTransform { 
			AnchorMin = "0 0.9", AnchorMax = "1 0.9", 
			OffsetMin = "0 -1200", OffsetMax = "0 0",
			Pivot = "0.5 1",
		},
...
| ConstraintCount | int32 | Value related to constraint type, ex: number of row or number of column |
| Enabled | bool? | Select if component is visible or not, default: true |
| Padding | string | Shorthand "padding" field: "l t r b" (or a single "x" to apply to all sides) |
